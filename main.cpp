...
public:
    ...
    virtual void run(const MatchFinder::MatchResult& Result)
    {
        ...
        auto reprange = CharSourceRange::getCharRange(expectation_cast->getLParenLoc(),
            expectation_cast->getSubExprAsWritten()->getBeginLoc());
        auto typeofstr = Lexer::getSourceText(CharSourceRange::getTokenRange(expectation_cast->getLParenLoc().getLocWithOffset(1),
            expectation_cast->getRParenLoc().getLocWithOffset(-1)),
            srcmng, Result.Context->getLangOpts());
